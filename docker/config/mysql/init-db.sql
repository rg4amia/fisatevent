...
--
-- Hôte : localhost:8889
-- Généré le : mar. 10 mai 2022 à 16:55
...
(5, '2022_05_05_220006_create_secteur_activites_table', 2),
(6, '2022_05_05_223343_create_participants_table', 3);
...
INSERT INTO `participants` (`id`, `nom`, `prenom`, `fonction`, `nomdirigeantfonction`, `secteuractivite_id`, `pay_id`, `ville`, `adresse`, `email`, `telephone`, `mobile`, `fax`, `expositioncommerciale`, `forumdiscussion`, `rencontrebtob`, `reunionministerielle`, `sessionspecialeprojet`, `rendezvous`, `created_at`, `updated_at`) VALUES
(1, 'AMIA', 'THIERRY STEPHANE', 'INFORMATICIEN', 'BAMBA INZA', 11, 141, 'ABIDJAN', 'ANGRE CHATEAU', 'r4gamia@gmail.com', '2250747500630', '2250747500630', '2250747500630', 0, 1, 1, 1, 1, 1, '2022-05-10 09:40:21', '2022-05-10 09:40:21'),
(2, 'AMIA', 'THIERRY STEPHANE', 'INFORMATICIEN', 'BAMBA INZA', 11, 141, 'ABIDJAN', 'ANGRE CHATEAU', 'r4gamia@gmail.com', '2250147500630', '2250147500630', '2250147500630', 1, 1, 1, 1, 1, 1, '2022-05-10 10:22:06', '2022-05-10 10:22:06');
...
--
ALTER TABLE `pays`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;
