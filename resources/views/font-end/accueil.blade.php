            ...
            <div class="col-12 col-lg-7">
                <div class="hero__content hero__content--first">
                    ...
                    <p class="hero__tagline">
                        ...
                        "Modernisation des écosystèmes logistiques, des transports et des Infrastructures: durabilité,
                        sécurité, digitalisation
                        et employabilité des jeunes.
                        Quels défis et opportunités pour l'Afrique de demain?"
                    </p>
                    <div class="hero__btns">
                        <a data-scroll href="{{ route('fontend.index') }}#registration" class="hero__btn"
                ...
                <div class="hero__content hero__content--second">
                    <div class="hero__dates" id="hero__dates">
                        ...
                        <div class="hero__date hero__date--glass" data-depth="0.15">
                            ...
                            <div class="hero__date-text" style="border-top: 1px solid rgba(255,255,255,0.1);">SOFITEL
                                ABIDJAN HOTEL IVOIRE - <br> CÔTE D'IVOIRE</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="about">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <p>
                                <span class="first-letter">D</span>epuis 2009, Le Salon Africain des Transports et des
                            ...
                            <ul class="nav nav-tabs program__tabs" id="program__tabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="1-tab" data-toggle="tab"
                                        href="{{ route('fontend.index') }}#tab-1" role="tab" aria-controls="tab-1"
                                        aria-selected="true">
                                        Jour 1
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="2-tab" data-toggle="tab"
                                        href="{{ route('fontend.index') }}#tab-2" role="tab" aria-controls="tab-2"
                                        aria-selected="false">
                                        Jour 2
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="3-tab" data-toggle="tab"
                                        href="{{ route('fontend.index') }}#tab-3" role="tab" aria-controls="tab-3"
                                        aria-selected="false">
                                        Jour 3
                ...
                <div class="gallery">
                    ...
                    <figure class="gallery__item gallery__item--2">
                        <a href="{{ asset('assets_fontend/img/fisat/image-2.jpg') }}" title="There may not be a Title">
                            <img src="{{ asset('assets_fontend/img/fisat/image-2.jpg') }}"
                                alt="There may not be a Title" />
                        </a>
                    </figure>
                    <!-- end gallery item -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
                <div class="section__title section__title--border">
                    <h2>Inscription</h2>
                    <p>Vous désirez visiter le Salon Africain des Transports? Cliquez pour vous inscrire !!!</p>
                </div>
            </div>
            <!-- end section title -->
        </div>
        ...
        <div class="row row--grid">
            ...
            <div class="col-12 col-md-6 order-md-1 col-lg-4 order-lg-1">
                <div class="pass">
                    ...
                    <a href="{{ route('fontend.index') }}#pass-modal" class="pass__btn open-modal"
                        style="background: linear-gradient(65deg, #c55d03 0%, #eb8326 100%);"><span>Réservation</span></a>
                </div>
            </div>
            <!-- end pass -->
            ...
            <div class="col-12 col-md-6 order-md-2 col-lg-4 order-lg-3">
                <div class="pass">
                    ...
                    <a href="{{ route('fontend.index') }}#pass-modal"
                        style="background: linear-gradient(65deg, #c55d03 0%, #eb8326 100%);"
                        class="pass__btn open-modal"><span>Réservation</span></a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="section__title section__title--between section__title--border">
                    ...
                    <p>Que vous souhaitiez bénéficier d’une visibilité maximale, d’une présence renforcée ou d’une
                        exposition ciblée,
                        nous avons la solution idéale pour vous. <br>
                        <a data-scroll href="{{ route('fontend.index') }}#contacts">Devenir partenaire.</a>
                    </p>
                </div>
            </div>
            <!-- end section title -->
                ...
                <div class="accordion" id="accordion">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="accordion__card">
                                <button class="collapsed" type="button" data-toggle="collapse" data-target="#collapse7"
                            ...
                            <div class="accordion__card">
                                <button class="collapsed" type="button" data-toggle="collapse" data-target="#collapse8"
