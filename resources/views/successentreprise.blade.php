        ...
        <div class="site-wrapper-reveal border-bottom features">
            ...
            <div class="checkout-main-area section-space--ptb_90">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <a target="_blank" href="{{ route('generate.imprimer.badge.entreprise') }}" class="btn btn-danger">IMPRIMER VOTRE BADGE</a>
                        </div>
                        <div class="col-lg-6">
                            <a target="_blank" href="{{ route('send-email.badge.entreprise') }}" class="btn btn-danger">RECEVOIR VOTRE BADGE PAR MAIL</a>
                        </div>
                    </div>
                </div>
            </div>
