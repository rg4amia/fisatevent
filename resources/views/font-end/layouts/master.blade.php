...
<body>
        ...
        <div class="container">
            ...
            <div class="row row--grid">
                ...
                <div class="col-12 col-md-6 order-md-1 col-lg-4 order-lg-1">
                    <div class="pass">
                        <h3 class="pass__title">Regular Pass</h3>
                        <div class="pass__price">$119 <span>USD</span></div>
                        <ul class="pass__list">
                            <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                                        d="M14.72,8.79l-4.29,4.3L8.78,11.44a1,1,0,1,0-1.41,1.41l2.35,2.36a1,1,0,0,0,.71.29,1,1,0,0,0,.7-.29l5-5a1,1,0,0,0,0-1.42A1,1,0,0,0,14.72,8.79ZM12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" />
                                </svg> 1 Comfortable seats</li>
                            <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                                        d="M14.72,8.79l-4.29,4.3L8.78,11.44a1,1,0,1,0-1.41,1.41l2.35,2.36a1,1,0,0,0,.71.29,1,1,0,0,0,.7-.29l5-5a1,1,0,0,0,0-1.42A1,1,0,0,0,14.72,8.79ZM12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" />
                                </svg> Free lunch and coffee</li>
                        ...
                        <div class="pass__progress">
                            <div class="progress-bar" role="progressbar" style="width: 62%" aria-valuenow="62"
                                aria-valuemin="0" aria-valuemax="100" aria-label="regular-pass"></div>
                        </div>
                ...
                <div class="col-12 order-md-3 col-lg-4 order-lg-2">
                    <div class="pass pass--dark">
                        <h3 class="pass__title">Standart Pass</h3>
                        <div class="pass__price">$189 <span>USD</span></div>
                        <ul class="pass__list">
                            <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                                        d="M14.72,8.79l-4.29,4.3L8.78,11.44a1,1,0,1,0-1.41,1.41l2.35,2.36a1,1,0,0,0,.71.29,1,1,0,0,0,.7-.29l5-5a1,1,0,0,0,0-1.42A1,1,0,0,0,14.72,8.79ZM12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" />
                        ...
                        <div class="pass__progress">
                            <div class="progress-bar" role="progressbar" style="width: 73%" aria-valuenow="73"
                                aria-valuemin="0" aria-valuemax="100" aria-label="standart-pass"></div>
                        </div>
                ...
                <div class="col-12 col-md-6 order-md-2 col-lg-4 order-lg-3">
                    <div class="pass">
                        <h3 class="pass__title">Premium Pass</h3>
                        <div class="pass__price">$249 <span>USD</span></div>
                        <ul class="pass__list">
                            <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                                        d="M14.72,8.79l-4.29,4.3L8.78,11.44a1,1,0,1,0-1.41,1.41l2.35,2.36a1,1,0,0,0,.71.29,1,1,0,0,0,.7-.29l5-5a1,1,0,0,0,0-1.42A1,1,0,0,0,14.72,8.79ZM12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" />
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section__title section__title--between section__title--border">
                        <h2>Some Of Our <br>Awesome Sponsors</h2>
                        <p>The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters,
                            as opposed to using 'Content here, content here'. <br><a data-scroll
                                href="index.html#contacts">Become a partner.</a></p>
                    </div>
                </div>
                <!-- end section title -->
    ...
    <div id="pass-modal" class="zoom-anim-dialog mfp-hide modal">
        ...
        <form action="index.html#" class="modal__form">
    ...
    <div id="about-modal" class="zoom-anim-dialog mfp-hide modal modal--article">
        ...
        <div class="modal__article">
            ...
            <p>
                ...
                in some form, by injected humour, or randomised words which don't look even slightly believable. If you
                are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden
                in the middle of text. <a href="index.html#">Link</a> the Lorem Ipsum generators on the Internet tend to
